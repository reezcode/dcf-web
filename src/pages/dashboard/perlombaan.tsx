                ...
                <div className="flex w-full h-full mb-10 backdrop-blur-3xl">
                    ...
                    <div className="w-full pb-16 p-7">
                        ...
                        <div className='flex flex-col justify-around h-full'>
                            <div className="h-full my-4 overflow-hidden bg-center bg-cover rounded-md bg-dcf-light-brown lg:my-2" style={{backgroundImage: "url('../../kompetisi.svg')",}}>
                            ...
                            <div className="h-full my-4 overflow-hidden bg-center bg-cover rounded-md bg-dcf-light-brown lg:my-2" style={{backgroundImage: "url('../../lkti.svg')",}}>
                                <div className="w-full h-full bg-gradient-to-r from-dcf-light-brown from-50% to-dcf-light-brown/30 to-100% p-5 flex flex-col justify-end overflow-hidden">
