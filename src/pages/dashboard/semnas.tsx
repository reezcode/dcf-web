      ...
      >
        <div className="flex w-full h-full mb-4 backdrop-blur-3xl">
          ...
          <div className="w-full pb-16 p-7">
            ...
            <p className="py-2 pl-2 pr-10 my-4 text-sm font-semibold bg-white rounded-md shadow-lg lg:text-base w-fit h-fit shadow-dcf-dark-brown/30">
              The Role of Green Chemistry to Maintain the Sustainable Energy
            </p>
            <div className="flex ">
              ...
              <div
                className="hidden w-1/2 p-10 bg-no-repeat bg-contain md:block"
                style={{ backgroundImage: "url('../../mascot2.svg')" }}
              ></div>
            </div>
          </div>
        </div>
