...
export default function Home() {
  return (
    <Layout
      pageTitle="DCF 2023 | Diponegoro Chemistry Fair 2023"
      description="Website DCF 2023 oleh HMK UNDIP"
    >
      ...
      <PosterSection />
      <TimelineSection
        desc="Timeline Pelaksanaan Rangkaian Acara Diponegoro Chemistry Fair 2023"
        timelineData={timelineGeneral}
      />
      <TestimoniSection />
      <Container />
