        ...
        <div>
          ...
          <div className="flex justify-center gap-2 my-2">
            <div className="w-[35px] h-[35px] bg-dcf-light-brown  ease-in duration-300 rounded-full hover:bg-dcf-light-brown/80 hover:translate-y-1 flex justify-center items-center">
              <a target="_blank" href='https://www.instagram.com/dcfundip/'>
            ...
            <div className="w-[35px] h-[35px] bg-dcf-light-brown  ease-in duration-300 rounded-full hover:bg-dcf-light-brown/80 hover:translate-y-1 flex justify-center items-center">
              <a target="_blank" href='https://twitter.com/dcfundip'>
            ...
            <div className="w-[35px] h-[35px] bg-dcf-light-brown  ease-in duration-300 rounded-full hover:bg-dcf-light-brown/80 hover:translate-y-1 flex justify-center items-center">
              <a target="_blank" href='https://www.facebook.com/dcfundip'>
            ...
            <div className="w-[35px] h-[35px] bg-dcf-light-brown  ease-in duration-300 rounded-full hover:bg-dcf-light-brown/80 hover:translate-y-1 flex justify-center items-center">
              <a target="_blank" href='https://www.youtube.com/c/HMKUndip'>
