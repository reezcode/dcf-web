...
export default function SidebarAdmin() {
    return (
        <div className='flex-col items-center hidden h-screen p-10 mb-20 bg-white w-1/8 lg:mb-0 lg:flex'>
            <img src="../../logo-dcf.svg" alt="" className='w-3/5 px-5 py-2 rounded-md bg-dcf-brown/60'/>
            <div>
                <div className='flex items-center px-2 py-3 m-auto my-10 rounded-md w-[200px] items bg-dcf-light-brown/60 h-[70px]'>
                    <div className='h-full w-[40px] bg-cover mx-3' style={{backgroundImage: "url('../../mascot2.svg')",}}>
                    </div>
                    <div>
                        <p className='text-sm font-medium'>Askari</p>
                        <p className='pr-5 text-sm'>Admin DCF</p>    
                    </div>
                </div>
                <div>
                    <ul>
                        ...
                        <li>
                            <Link href='/admin/semnas' className='flex items-center p-2 my-3 rounded-full hover:bg-dcf-light-brown/60'>
