...
export default function About({data} : AboutProps) {
    ...
    return (
        <div className="w-full h-fit rounded-[20px] sm:rounded-[40px] relative top-[-40px] bg-white px-10 lg:px-44 text-sm sm:text-base shadow-[0_-22px_40px_#967E7610]" id="about" data-aos="fade-up">
