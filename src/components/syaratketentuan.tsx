...
export default function SyaratKetentuan({ data }: SKProps) {
  ...
  return (
    <motion.div ref={ref} animate={animation} className="mb-12 m-font" id="sk">
      <h1 className="p-3 text-2xl font-bold text-center sm:text-4xl">
        {title}
      </h1>
      ...
      <div className="flex flex-col items-center my-5 md:justify-center md:h-fit lg:flex-row">
        <motion.div
          ref={ref}
          animate={slideL}
          className="w-11/12 lg:w-[400px] h-[300px] lg:h-[400px] overflow-hidden bg-dcf-blue rounded-[20px] p-3 mx-5 shadow-xl shadow-dcf-light-brown/50 hover:shadow-dcf-light-brown/80 duration-300 hover:scale-105 cursor-pointer bg-cover"
        ...
        >
              ...
              <div>
                <p className="flex">
                  <svg
                    ...
                    stroke-width="2"
                    stroke="currentColor"
                    className="w-4 h-4 mt-1 mr-3 text-green-500 lg:w-5 lg:h-5 shrink-0"
                  >
                    <path
          ...
          <div>
            ...
            <div className="flex flex-col items-center justify-between px-3 lg:flex-row">
              <div>
                <p className="text-sm font-bold text-center lg:text-left">
                  Biaya Pendaftaran
                </p>
                <p className="text-lg text-center lg:text-left">{harga}</p>
              </div>
              <Link href={regist}>
                <button className="self-center py-2 m-3 font-semibold duration-300 shadow-xl bg-dcf-light-brown md:w-min px-9 rounded-xl hover:bg-dcf-light-brown/80 hover:scale-105 shadow-dcf-light-brown/50 hover:shadow-dcf-light-brown/80 hover:text-dcf-dark-brown">
                  Daftar
                </button>
              </Link>
            </div>
