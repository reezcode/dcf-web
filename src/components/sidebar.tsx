  ...
  return (
    <div className="flex-col items-center hidden w-1/4 h-screen p-10 mb-20 bg-white lg:mb-0 lg:flex">
      <img
        src="../../logo-dcf.svg"
        alt=""
        className="w-3/5 px-5 py-2 rounded-md bg-dcf-brown/60"
      />
      <div>
        <div className="flex items-center px-1 py-2 m-auto my-10 rounded-md w-6/7 items bg-dcf-light-brown/60 h-fit">
          ...
          <div>
            ...
            <p className="pr-5 text-sm">{email}</p>
          </div>
        </div>
        <div>
          <ul>
            <li>
              <Link
                href="/dashboard"
                className="flex items-center p-2 my-3 rounded-full hover:bg-dcf-light-brown/60"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
